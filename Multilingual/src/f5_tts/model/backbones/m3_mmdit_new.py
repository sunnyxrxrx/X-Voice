...
from f5_tts.model.modules import (
    ...
    M3MMDiTBlock_new, M3DiTBlock_new, FinalBlock,
    TimestepEmbedding,
...
class TextEmbedding(nn.Module):
    def __init__(self, out_dim, text_num_embeds, mask_padding=False,average_upsampling=False, conv_layers=0, conv_mult=2):
        ...
        if average_upsampling:
            print("Warning: in M3TTS, average upsamping should be false. ")
...
class M3_MMDiT_new(nn.Module):
    def __init__(
        ...
        *,
        ...
        ff_mult=4,
        mel_dim=100, # 输入音频维度
        text_num_embeds=256, # 词汇表大小
        text_dim=None,
        text_mask_padding=False,
        text_embedding_average_upsampling=False, # 无意义
        qk_norm=None,
        conv_layers=0,
        pe_attn_head=None,
        ...
        self.text_embed = TextEmbedding(out_dim=text_dim, text_num_embeds=text_num_embeds, mask_padding=text_mask_padding)
        ...
        self.final_layer = FinalBlock(dim, out_dim=mel_dim)
