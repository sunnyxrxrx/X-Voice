...
python3 get_wav_res_ref_text1.py $meta_lst $output_dir $output_dir/wav_res_ref_text
...
python3 verification_pair_list_v2.py $thread_dir/thread-00.lst \
    --model_name wavlm_large \
    --checkpoint $checkpoint_path \
    --scores $out_dir/thread-00.sim.out \
    --wav1_start_sr 0 \
    --wav2_start_sr 0 \
    --wav1_end_sr -1 \
    --wav2_end_sr -1 \
